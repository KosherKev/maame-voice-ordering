...
router.post('/fulfillments/:fulfillmentId/mark-delivered', auth_js_1.authMiddleware, (0, auth_js_1.requireRole)(['admin']), idempotency_js_1.idempotencyMiddleware, fulfillmentsController_js_1.fulfillmentsController.markDelivered);
