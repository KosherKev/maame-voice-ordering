...
exports.ClaudeLlmClient = void 0;
const env_js_1 = require("../../config/env.js");
const index_js_1 = require("../../errors/index.js");
class ClaudeLlmClient {
    async processSpeech(catalog, currentBasket, history, newUserUtterance) {
        try {
...
"${newUserUtterance}"`;
            ...
            const response = await fetch('https://api.anthropic.com/v1/messages', {
                ...
                headers: {
                    ...
                    'x-api-key': env_js_1.env.ANTHROPIC_API_KEY,
            ...
            const decision = toolUseContent.input;
            return {
            ...
            throw new index_js_1.UpstreamProviderError(`Claude LLM client failed: ${error.message}`);
        }
    }
}
exports.ClaudeLlmClient = ClaudeLlmClient;
exports.default = ClaudeLlmClient;
