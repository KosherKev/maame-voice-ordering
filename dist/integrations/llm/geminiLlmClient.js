...
"${newUserUtterance}"`;
            ...
            const url = `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-lite:generateContent?key=${env_js_1.env.GOOGLE_API_KEY}`;
            ...
            throw new index_js_1.UpstreamProviderError(`Gemini LLM client failed: ${error.message}`);
        }
    }
}
